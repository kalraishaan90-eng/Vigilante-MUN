...
export default function DomeGallery({
  ...
  grayscale = false,
  // ChromaGrid glow effect props
  chromaRadius = 300,
  chromaDamping = 0.45,
  chromaFadeOut = 0.6,
  chromaEase = 'power3.out'
}) {
  ...
  // ChromaGrid GSAP QuickSetter Initialization
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const ro = new ResizeObserver(entries => {
      ...
      root.style.setProperty('--r', `${chromaRadius}px`);
